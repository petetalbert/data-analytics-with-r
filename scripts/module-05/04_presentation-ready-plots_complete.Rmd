...
tuition_cost %>%
  ...
  theme_minimal() +
  theme(panel.grid.minor.x = element_blank(), panel.grid.major.y = element_blank(), legend.position = "none") +
  labs(
    title = "Iowa has the most expensive out-of-state tuition",
    subtitle = "Median out-of-state tuition by state in the upper-midwest",
    x = element_blank(),
    y = element_blank()
  )
```
